...
include("php/models/Room.php");
include("components/Table.php");
include("components/Modal.php");



$title = "Reservation MIS - Rooms";

$database = new Database();
$db = $database->connect();

$roomsObj = new Room($db);
$rooms = $roomsObj->read();
...
$newModal->setContent(<<<FORM
		<form method="POST" id="newForm" action="php/functions/room/create.php">
